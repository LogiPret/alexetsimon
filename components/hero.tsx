...
export function Hero() {
  return (
    <section className="pt-14 relative overflow-hidden w-full bg-[#182542] h-[100svh] max-h-[100svh]">
      {/* Background Image - Fills viewport, crops if needed */}
      <div className="relative w-full h-full">
        ...
        {/* Content overlay at bottom of image - Hidden on mobile */}
        <div className="hidden md:block absolute bottom-32 left-0 right-0 z-10">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <motion.p
              className="text-2xl text-white/90 max-w-xl mx-auto text-pretty drop-shadow-lg"
